  ...
  content: [
...

    {
      ...
      rows: [
        ...
        ['MIRTAZAPINE', 'TCA (lofepramine)', 'Cross-taper cautiously at low TCA dose', 'Both have sedating/anticholinergic properties — monitor for additive sedation'],
        ['MIRTAZAPINE', 'MAOI', 'Taper mirtazapine → stop → wait 2 weeks → start MAOI', 'Mirtazapine has serotonergic activity — standard 2-week MAOI washout required'],
