...
export const rhinosinusitis: Note = {
  ...
  content: [
    ...
    {
      type: 'para',
      text: 'Most common form of rhinitis — affects ~20% of the UK population. Caused by IgE-mediated hypersensitivity to inhaled allergens. Always ask about asthma — rhinitis and asthma are part of the same "united airway" and treating rhinitis improves asthma control.',
    },
    {
      type: 'table',
      caption: 'ARIA Classification — Frequency × Severity (determines treatment intensity)',
      headers: ['', 'Mild', 'Moderate–Severe'],
      rows: [
        ['Mild definition', 'No sleep disturbance; normal daily activities, work/school; no troublesome symptoms', '—'],
        ['Moderate–Severe definition', '—', 'Any of: sleep disturbance; impaired daily activities/sport/leisure; impaired school or work performance; troublesome symptoms'],
        ['Intermittent\n(<4 days/week OR <4 weeks/year)', 'OTC antihistamine PRN; allergen avoidance', 'Oral antihistamine + INCS spray — 1 month trial'],
        ['Persistent\n(≥4 days/week AND ≥4 weeks/year)', 'Consider INCS spray; allergen avoidance', 'INCS spray continuously; antihistamine PRN or regular; step up if needed'],
      ],
    },
    {
      type: 'table',
      caption: 'Seasonal (Intermittent) vs Perennial (Persistent) — key differences',
      headers: ['Feature', 'Seasonal / Intermittent', 'Perennial / Persistent'],
      rows: [
        ['Typical allergens', 'Tree pollen (Spring), Grass pollen (May–July), Weed pollen (Summer–Autumn)', 'House dust mite (year-round), Pet dander (cat, dog), Mould spores'],
        ['Pattern', 'Clear seasonal onset; resolves between seasons', 'Year-round; may worsen in Spring/Autumn (HDM peaks)'],
        ['Main symptoms', 'Sneezing, itching, watery eyes; nasal obstruction less prominent', 'Persistent nasal blockage, rhinorrhoea; less itching/sneezing'],
        ['Diagnosis', 'Clinical history; specific IgE or skin prick test if uncertain', 'Specific IgE or skin prick test to confirm HDM/pet allergen'],
        ['INCS timing', 'Start 2 weeks before season begins; stop after season', 'Use continuously — do not stop between seasons'],
        ['Antihistamine', 'PRN (as needed) during season, or regular during exposure', 'PRN for breakthrough sneezing/itching on top of INCS'],
        ['Immunotherapy', 'Effective for grass/tree pollen (Grazax, Pollinex)', 'Effective for HDM (Acarizax sublingual tablet); not for pet dander'],
      ],
    },
    {
      type: 'table',
    ...
    { type: 'heading', level: 2, text: 'Non-Allergic Rhinitis — Types & Treatment' },
    {
      type: 'para',
      text: 'Non-allergic rhinitis accounts for ~50% of all chronic rhinitis. Skin prick test and specific IgE are negative. Often a diagnosis of exclusion. Several distinct subtypes exist with different triggers and treatments.',
    },
    {
      type: 'table',
      caption: 'Non-allergic rhinitis subtypes',
      headers: ['Subtype', 'Triggers / Features', 'Treatment'],
      rows: [
        ['Vasomotor / Idiopathic\n(most common)', 'Temperature change (cold air, entering warm room), humidity, exercise, strong smells, alcohol, emotion, spicy food. Autonomic dysregulation — excess parasympathetic tone.', 'Avoid triggers. INCS spray (2–3 month trial — modest benefit). Ipratropium 0.03% nasal spray if watery rhinorrhoea predominates. Refer ENT if no response.'],
        ['NARES\n(Non-Allergic Rhinitis with Eosinophilia Syndrome)', 'Persistent sneezing, profuse watery rhinorrhoea, anosmia. SPT/IgE negative. Nasal cytology shows eosinophilia. Associated with aspirin sensitivity and polyps.', 'INCS spray — responds well (best of non-allergic types). Treat as per allergic rhinitis ladder. Refer ENT if polyps develop.'],
        ['Occupational rhinitis', 'Work-related: flour dust (bakers), latex (healthcare), wood dust, animals, chemicals, isocyanates. Symptoms improve away from work — classic history.', 'Confirm allergen via specific IgE / SPT. Allergen avoidance (PPE, ventilation, job change). INCS. Refer occupational physician. Legally reportable if occupational.'],
        ['Drug-induced rhinitis', 'NSAIDs/aspirin (aspirin-exacerbated disease). ACE inhibitors. Beta-blockers. COCP / HRT. Alpha-blockers. Cocaine / intranasal drugs. Decongestant overuse (rhinitis medicamentosa).', 'Identify and stop offending drug if clinically safe. INCS bridge. Consider alternative antihypertensive if ACE-related.'],
        ['Rhinitis medicamentosa\n(decongestant rebound)', 'Rebound congestion from prolonged use of topical decongestants (xylometazoline, oxymetazoline) — typically >5–7 days. Addictive cycle of worsening congestion.', 'Wean off decongestant — abrupt or gradual. Start INCS to ease transition (fluticasone or mometasone for 4–6 weeks). Patient education on max 7-day decongestant rule.'],
        ['Hormonal rhinitis', 'Pregnancy (up to 20% affected; self-limiting post-partum). Menstrual cycle. Hypothyroidism. Acromegaly.', 'Treat underlying cause. Nasal saline irrigation. Fluticasone furoate (Avamys) safe in pregnancy. Pregnancy rhinitis — reassure; resolves after delivery.'],
        ['Atrophic rhinitis', 'Elderly. Post-surgical. Chronic infection. Wide nasal cavity, thick crusting, paradoxical sensation of blockage despite wide airway. Ozaena (offensive smell).', 'Nasal saline irrigation. Nasal emollients (Vaseline to crusts). ENT referral for persistent cases.'],
      ],
    },
    {
      type: 'callout',
      variant: 'tip',
      title: 'Ipratropium Bromide 0.03% Nasal Spray (Rinatec) — Key Points',
      items: [
        'Indication: vasomotor/non-allergic rhinitis where WATERY rhinorrhoea is the dominant symptom ("old man\'s drippy nose")',
        'Dose: 2 sprays each nostril 2–3 times daily — use regularly, not PRN',
        'Onset: effect within 15–30 minutes of dose; works on secretions not congestion',
        'Does NOT treat nasal blockage or sneezing — not useful if congestion predominates',
        'Anticholinergic effects (rare with intranasal route): dry mouth, epistaxis, urinary retention in men with BPH',
        'Caution: closed-angle glaucoma risk if spray gets in eyes — protect eyes when using',
        'Can combine with INCS if both secretions and congestion present',
        'POM — prescribe generically as "ipratropium bromide 0.03% nasal spray"',
      ],
    },
    {
      type: 'callout',
      variant: 'info',
      title: 'Diagnosing Non-Allergic vs Allergic Rhinitis',
      items: [
        'Skin prick test (SPT) — gold standard; results suppressed by antihistamines (stop 3–7 days before), TCAs, topical steroids',
        'Specific IgE (blood test) — alternative if SPT not possible; less sensitive for some allergens',
        'Both tests less reliable with food allergens than inhaled; interpret alongside clinical history',
        'Total IgE — elevated in atopy but not diagnostic alone',
        'Nasal cytology — eosinophils on smear suggests NARES even if SPT negative',
        'Symptoms improve away from work/home — consider occupational or environmental cause',
        'Refer to allergy clinic if: diagnosis unclear, considering immunotherapy, severe/refractory, suspected occupational',
      ],
    },
